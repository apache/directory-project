...
public class NamingContext implements Context {
     ...
     * @param name external name for the context
    ...
    /**
     * Builds a naming context using the given external name, environment and 
     * initial bindings.
     * 
     * @param env environment
     * @param name external context name
     ...
     * 
     * @return true if this context is writable
     */
