...
public interface LdapClient
{
    /**
        ...
        /**
         * Connects the socket to the server.  This will not perform a bind,
         * it will only establish the connection.  The bind will call this, it 
         * does not have to be done manually.  This can be used to test or 
         * step through the communication process.
         * 
         * @throws UnknownHostException Cannot find the host 
         * @throws IOException Error establishing the socket connection
         */    
        ...
        /**
         * Close the socket connection to the server.  This will help
         * keep the server clean.
         *  
         * @throws IOException Error terminating the socket connection
         */
         ...
         *  
         * @param a_deleteDn DN of the entry to delete
         * @return Response Object
         * @throws IOException Error with the IO communication to the server
         */
        public LdapClientResponse ldapDelete ( String a_deleteDn ) 
            throws IOException;
            
        
        
        /**
         * @TODO Redocument this method
         * 
         * @param a_stream Stream to read the input from.  This can either
         * be STDIN or a file
         * @return Response Object
         * @throws IOException Error with the IO communication to the server 
         */    
         ...
         * The result code and the actuall search results will be placed in
         * the LdapClientResponse objected returned
         * 
         * @param a_filterString Search filter to use
         * @return Response Object containing the result code and search 
         * results
         * @throws IOException  Error with the IO communication to the server
         */
