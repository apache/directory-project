...
public class LdapTester
{
    ...
    class SessionWindowListener implements ActionListener 
    {
        public void actionPerformed(ActionEvent e)
        {           
            new SessionListUI( m_config ) ;           
        }
    }
    ...
    class RefreshOutputListener implements ActionListener 
    {
        public void actionPerformed(ActionEvent e)
        {
            String l_outText = new String () ;
            LdapTestSession l_session ;
            l_outText = m_config.getSessionCount() + " Sessions \n" ;
            for (int l_index = 0 ; l_index < m_config.getSessionCount() ; l_index ++ )
            {
                l_session = new LdapTestSession() ;
                l_session = m_config.getSession( l_index ) ;
                l_outText =  l_outText + "\t" + l_session.getHost() + "\n"  ;
            }           
            output.setText( l_outText ) ;    
        }
    } 
