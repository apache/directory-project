...
{                      
    private static final long serialVersionUID = -7992392313142800515L;
    private JList list;
    ...
    public SessionListUI( TestConfiguration a_config ) 
    {
        ...
        for (int l_index = 0 ; l_index < a_config.getSessionCount() ; l_index ++ ) 
        {
            ...
            l_listEntry = a_config.getSession( l_index ).getSessionName() 
                + " - " + a_config.getSession( l_index ).getSessionDescription() ;
    ...
    class DeleteListener implements ActionListener 
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            ...
            //------------------------------------------------------------
            LdapTestSession l_session = l_config.getSession( l_index ) ;
            ...
            {
                l_config.removeSession( l_index ) ;
    ...
    class AddListener implements ActionListener  
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            new SessionAddUI( l_config, listModel, -1 ) ;           
        }
    }
    ...
    class ModifyListener implements ActionListener  
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            new SessionAddUI( l_config, listModel, list.getSelectedIndex() ) ;               
        }
    }
