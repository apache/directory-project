...
public class TestConfiguration
{
    ...
    private LdapTestSession getSessionConfig( Node node )
    {
        ...
        for ( Node child = node.getFirstChild(); child != null; child = child.getNextSibling() )
        {
            ...
            else if ( name.equalsIgnoreCase( "descr" ) )
            {
    ...
    public void readConfig( String fileName )
    {
        ...
        for ( child = document.getFirstChild(); child != null; child = child.getNextSibling() )
        {
            ...
            if ( ( name.equalsIgnoreCase( "LdapTester" ) ) && ( child.hasChildNodes() ) )
            {
                break;
            }
        }
        ...
        for ( child = child.getFirstChild(); child != null; child = child.getNextSibling() )
        {
            ...
            {
                sessions.add( getSessionConfig( child ) );
            }
            else if ( name.equalsIgnoreCase( "testcase" ) )
            {
                testCases.add( getTestCaseConfig( child ) );
            }
        }
    }
    ...
    {
        return ( LdapTestSession ) sessions.get( index );
    }
