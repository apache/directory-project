...
{                      
    private static final long serialVersionUID = -1857928186350218573L;
    private JList list;
    ...
    class AddListener implements ActionListener  
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            new TestCaseAddUI( l_config, listModel, -1 ) ;           
        }
    }
    ...
    class ModifyListener implements ActionListener  
    {
        ...
        public void actionPerformed(ActionEvent e) 
        {
            new TestCaseAddUI( l_config, listModel, list.getSelectedIndex() ) ;               
        }
    }
