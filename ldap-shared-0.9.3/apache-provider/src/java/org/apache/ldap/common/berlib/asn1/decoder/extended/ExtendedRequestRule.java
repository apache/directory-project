...
/**
 * Digester rule that instantiates ExtendedRequest objects and pushes them onto
...
public class ExtendedRequestRule extends AbstractRule
{
    ...
    public void tag( int id, boolean isPrimitive, TypeClass typeClass )
    {
        ...
        if ( LdapTag.EXTENDED_REQUEST != tag )
        {
            throw new IllegalArgumentException( "Expected a ExtendedRequest tag"
                + " id but got a " + tag ) ;
        }

        ExtendedRequestImpl req = new
                ExtendedRequestImpl( getDigester().popInt() ) ;
