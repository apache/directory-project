...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/Control.java
//
...
public class Control implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.print(Hex.toString(controlType));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    ...
    if (controlValue != null) {
      ...
      os.print(Hex.toString(controlValue));
      os.println();
    }
