...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/PartialAttributeListSeqSetOf.java
//
...
public class PartialAttributeListSeqSetOf extends Hashtable implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public void print (PrintStream os, int indent) {
    ...
    for (java.util.Enumeration e = elements(); e.hasMoreElements();) {
      ...
      os.print(Hex.toString(((byte[])(e.nextElement()))));
