...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/ModifyDNRequest.java
//
...
public class ModifyDNRequest implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public void print (PrintStream os, int indent) {
    ...
    if (newSuperior != null) {
      ...
      os.print(Hex.toString(newSuperior));
      os.println();
    }
