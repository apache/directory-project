...
import org.apache.ldap.common.berlib.snacc.ldap_v3.CompareResponse ;
...
{
	static org.apache.ldap.common.message.CompareResponse
        transformFromSnacc( LDAPMessage a_snaccMessage )
        throws ProviderException
    {
		CompareResponseImpl l_response =
            new CompareResponseImpl( a_snaccMessage.messageID.intValue() ) ;
        LDAPMessageChoice l_snaccOp = a_snaccMessage.protocolOp ;
        CompareResponse l_snaccResponse = l_snaccOp.compareResponse ;
    ...
    static LDAPMessage
        transformToSnacc(org.apache.ldap.common.message.CompareResponse a_resp )
    {
        LDAPMessage l_snaccMessage = Utils.prepareEnvelope( a_resp ) ;
        LDAPMessageChoice l_snaccOp = l_snaccMessage.protocolOp ;
		l_snaccOp.choiceId = LDAPMessageChoice.COMPARERESPONSE_CID ;

        CompareResponse l_snaccResponse = new CompareResponse() ;
        l_snaccOp.compareResponse = l_snaccResponse ;
