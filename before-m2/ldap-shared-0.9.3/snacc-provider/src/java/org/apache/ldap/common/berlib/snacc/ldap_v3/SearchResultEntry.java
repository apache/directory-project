...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/SearchResultEntry.java
//
...
public class SearchResultEntry implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public org.apache.ldap.common.berlib.snacc.ldap_v3.PartialAttributeList attributes = new PartialAttributeList();
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.print("objectName = ");
    os.print(Hex.toString(objectName));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("attributes = ");
