...
public class NewPermissionPanel extends JPanel
{
    ...
    private JTable existingPermissionsTable = null;
    private ExistingPermissionsTableModel existingPermissionsTableModel = null; //  @jve:decl-index=0:visual-constraint=""
    ...
    private void initialize()
    {
        ...
        this.setBorder( javax.swing.BorderFactory.createTitledBorder( null, "New Permission",
    ...
    private JLabel getIconLabel()
    {
        if ( iconLabel == null )
        {
            ...
            iconLabel.setIcon( new ImageIcon( getClass().getResource(
                "/org/safehaus/triplesec/admin/swing/new_permission2_48x48.png" ) ) );
    ...
    private JPanel getJPanel()
    {
        if ( jPanel == null )
        {
            ...
            jLabel1 = new JLabel();
            jLabel1.setText("Permission Name:");
            ...
            jPanel.add(getPermissionNameTextField(), gridBagConstraints5);
    ...
    {
        if ( permissionNameTextField.getText() == null || permissionNameTextField.getText().equals( "" ) )
        {
            return;
        }
...
//        }
    ...
    private JTabbedPane getCenterTabbedPane()
    {
        if ( centerTabbedPane == null )
        {
            ...
            centerTabbedPane.addTab( "Existing", null, getExistingPanelTab(),
                "Copy a permission from any one of these existing permissions." );
        }
    ...
    private JScrollPane getJScrollPane()
    {
        if ( jScrollPane == null )
        {
            ...
            jScrollPane.setViewportView( getExistingPermissionsTable() );
        }
        return jScrollPane;
    }
    ...
    {
        if ( existingPermissionsTable == null )
        {
            existingPermissionsTable = new JTable();
            existingPermissionsTable.setSelectionMode( ListSelectionModel.SINGLE_SELECTION );
            existingPermissionsTable.getSelectionModel().addListSelectionListener( new ListSelectionListener()
            {
...
//                    descriptionTextArea.setText( permission.getDescription() );
        ...
        return existingPermissionsTable;
    }
    ...
    {
        if ( existingPermissionsTableModel == null )
        {
            existingPermissionsTableModel = new ExistingPermissionsTableModel();
        }
...
//            {
//                case ( 0 ):
//                    return child.getPermissionObject();
//                case ( 1 ):
//                    return ( ( Permission ) child.getPermissionObject() ).getCreatorsName();
//                case ( 2 ):
//                    return ( ( Permission) child.getPermissionObject() ).getCreateTimestamp();
//            }
