    ...
    extends BindOpts
{
    ...
    /**
     * Based in the command line arguments, determine if a file is
     * being used as the input for the LDIF entries
     * 
     * @return true if a file is being used as the input method
     */
     ...
     * 
     * @return the name of the file being used as the input method
     */
