...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/SaslCredentials.java
//
...
public class SaslCredentials implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.print("mechanism = ");
    os.print(Hex.toString(mechanism));
    os.println(',');
    if (credentials != null) {
      for(int ii = 0; ii < indent+2; ii++) os.print(' ');
      os.print("credentials = ");
      os.print(Hex.toString(credentials));
      os.println();
    }
