...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/SubstringFilterSeqOfChoice.java
//
//   Java class for ASN.1 definition SubstringFilterSeqOfChoice as defined in
//   module LDAP-V3.
//   This file was generated by Snacc for Java at Wed Nov 13 12:00:20 2002
//-----------------------------------------------------------------------------
...
public class SubstringFilterSeqOfChoice implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {

  static public final int INITIAL_CID	= 0x80000000 /* ASN1Tag.makeTag(ASN1Tag.CONTEXT_TAG_CLASS,0) */;
  static public final int ANY_CID	= 0x80000001 /* ASN1Tag.makeTag(ASN1Tag.CONTEXT_TAG_CLASS,1) */;
  static public final int FINAL1_CID	= 0x80000002 /* ASN1Tag.makeTag(ASN1Tag.CONTEXT_TAG_CLASS,2) */;
  ...
  public void print (PrintStream os, int indent) {
    ...
    case INITIAL_CID:
      ...
      os.print("initial = ");
      os.print(Hex.toString(initial));
      break;
    case ANY_CID:
      for(int ii = 0; ii < indent+2; ii++) os.print(' ');
      os.print("any = ");
      os.print(Hex.toString(any));
      break;
    case FINAL1_CID:
      for(int ii = 0; ii < indent+2; ii++) os.print(' ');
      os.print("final = ");
      os.print(Hex.toString(final1));
      break;
    }
