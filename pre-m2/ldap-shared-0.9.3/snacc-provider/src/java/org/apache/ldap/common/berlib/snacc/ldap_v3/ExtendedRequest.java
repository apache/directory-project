...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/ExtendedRequest.java
//
...
public class ExtendedRequest implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public void print (PrintStream os, int indent) {
    ...
    os.print(Hex.toString(requestName));
    os.println(',');
    if (requestValue != null) {
      for(int ii = 0; ii < indent+2; ii++) os.print(' ');
      os.print("requestValue = ");
      os.print(Hex.toString(requestValue));
      os.println();
    }
