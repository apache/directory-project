...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/ExtendedResponse.java
//
...
public class ExtendedResponse implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {

  /** member variable representing the sequence member resultCode of type LDAPResultEnum */
  public org.apache.ldap.common.berlib.snacc.ldap_v3.LDAPResultEnum resultCode = new LDAPResultEnum();
  ...
  public org.apache.ldap.common.berlib.snacc.ldap_v3.Referral referral = null;
  ...
  public ExtendedResponse (ExtendedResponse arg) {
    ...
    if (arg.referral != null) referral = new Referral(arg.referral);
  ...
  public void print (PrintStream os, int indent) {
    ...
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("matchedDN = ");
    os.print(Hex.toString(matchedDN));
    os.println(',');
    for(int ii = 0; ii < indent+2; ii++) os.print(' ');
    os.print("errorMessage = ");
    os.print(Hex.toString(errorMessage));
    os.println(',');
    if (referral != null) {
      for(int ii = 0; ii < indent+2; ii++) os.print(' ');
      os.print("referral = ");
    ...
    if (responseName != null) {
      ...
      os.print(Hex.toString(responseName));
      os.println(',');
    }
    if (response != null) {
      for(int ii = 0; ii < indent+2; ii++) os.print(' ');
      os.print("response = ");
      os.print(Hex.toString(response));
      os.println();
    }
