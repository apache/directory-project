...
//
//   File: build/snacc/src/ldapd/common/ber/ldap_v3/BindResponse.java
//
...
public class BindResponse implements org.apache.ldap.common.berlib.snacc.ldap_v3.LDAP_V3 {
  ...
  public void print (PrintStream os, int indent) {
    ...
    if (serverSaslCreds != null) {
      ...
      os.print(Hex.toString(serverSaslCreds));
      os.println();
    }
